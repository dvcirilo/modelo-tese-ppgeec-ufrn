...
fixa no texto (como aqui: \includegraphics{capitulos/figuras/eu}).
...
\fbox{\includegraphics[width=0.75\linewidth]{capitulos/figuras/belmonte}}
...
\includegraphics{capitulos/figuras/circulo}
...
\begin{figure}[htb] \begin{center}
\includegraphics{capitulos/figuras/pensador}
...
\input{capitulos/figuras/combinado.pdftex_t} % Se usar pdflatex
...
\begin{figure}[htbp]
\centering
\includegraphics{capitulos/figuras/grafico}
